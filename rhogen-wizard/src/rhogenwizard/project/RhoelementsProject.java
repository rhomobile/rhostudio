...
{
	public RhoelementsProject(IProject project)
	{
		m_project = project;
	}
	...
	public static boolean checkNature(IProject otherProject) 
	{
		...
		try 
		{
			IProjectNature nature = otherProject.getNature(RhoelementsNature.natureId);
	...
	public void addNature() throws CoreException, ProjectNotFoundException 
	{
		...
		newNatures[natures.length]   = RhoelementsNature.natureId; 		
