...
import rhogenwizard.builder.rhoelements.Builder;

public class RhoelementsNature implements IProjectNature 
{
	/**
	 * ID of this project nature
	 */
	public static final String natureId = "com.rhomobile.rhostudio.rhoelementsNature";
